...
const App = () => {
  ...
  const [topBy, setTopBy] = useState("population"); // "population" or "area"
  ...
  useEffect(() => {
    ...
    // Apply top 10 filter by population or area
    if (top10Filter) {
      updatedCountries = updatedCountries
        .sort((a, b) => b[topBy] - a[topBy]) // Sort by population or area
        .slice(0, 10);
    }
  ...
  // Extract continents and subregions for the filters
  ...
  return (
    <div>
      ...
      <label>
        ...
        <select
          ...
          onChange={(e) => {
            ...
            setSubregionFilter(""); // Clear subregion when continent is changed
          }}
        >
      ...
      <label>
        ...
        <select
          ...
          onChange={(e) => {
            ...
            setContinentFilter(""); // Clear continent when subregion is changed
          }}
        >
          <option value="">All</option>
      ...
      <button onClick={() => setSortAlphabetically(!sortAlphabetically)}>
        {sortAlphabetically ? "Unsort" : "Sort Alphabetically"}
      </button>

      {/* Render Filtered and Sorted Countries */}
